...
def change_image(image_number, download_button_const):
    download_button = find_image(get_resource_path('images/ideogram/download_button.png'), 0.95, 2, True)
...
def download_image(image_number, download_button_const):
    ...
    if find_image(get_resource_path('images/ideogram/download_button.png'), 0.8, 2, True) == None:
        change_image(image_number, download_button_const)
        return download_image(image_number, download_button_const)
...
def ideogram_download(direct=False):
    ...
    download_button_const = find_image(get_resource_path('images/ideogram/download_button.png'), 0.8)
