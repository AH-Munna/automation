...
def upload_to_canva (downloaded_image_pos=0):
    ...
    dragTo(canva_controls.left + 100, canva_controls.top + 100, duration=2)
    sleep(1.5)

    # # clone images
    for i in range (3):
        click(canva_controls.left + 358, canva_controls.top + 15, duration=0.3)

    moveTo(canva_controls.left + 200, canva_controls.top + 400, duration=0.3)
        ...
        for j in range (4):
            if i == j:
                ...
                def set_as_background():
                    click(find_image("images/canva/set_as_backgroung.png", 0.9), duration=0.3)
                ...
                click(canva_controls.left + 200, canva_controls.top + 450, duration=0.3)
                hotkey('delete')
        if i != 3:
            moveTo(canva_controls.left + 200, canva_controls.top + 450, duration=0.3)
            scroll(screenHeight-80)

    # delete uploaded images
    click(download_files, duration=0.3)
    hotkey('delete')